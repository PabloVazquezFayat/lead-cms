...
export default function NavbarModal(props) {
    ...
    return (
        <div className="modal-navbar">
            <button className="modal-button" data-role="open" onClick={toggleModal}>Edit</button>
            <div className="modal-wrapper" style={style}>
                ...
                <div className="modal-actions-wrapper">
                    ...
                    <button id={_id} className="modal-button modal-button-save" onClick={handleSaveClick}>Save</button>
                </div>
            </div>
        </div>
    );
