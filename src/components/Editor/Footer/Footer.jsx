					...
					<div className="footer-social-wrapper">
						...
						<ul>
							{facebook ? (
								<li>
									<a href={facebook}>
										<i className="fab fa-facebook-f footer-sm-box"></i>
									</a>
								</li>
							) : null}
							{instagram ? (
								<li>
									<a href={instagram}>
										<i className="fab fa-instagram footer-sm-box"></i>
									</a>
								</li>
							) : null}
							{twitter ? (
								<li>
									<a href={twitter}>
										<i className="fab fa-twitter footer-sm-box"></i>
									</a>
								</li>
							) : null}
							{linkedin ? (
								<li>
									<a href={linkedin}>
										<i className="fab fa-linkedin footer-sm-box"></i>
									</a>
								</li>
							) : null}
						</ul>
				...
				<div className="footer-wrapper">
					...
					<div className="footer-content">
						...
						<ul className="footer-nav-links">
							...
							<li>
								<a href="/news">follow our newsletter</a>
							</li>
							<li>
								<a href="/careers">see our career opportunities</a>
							</li>
							<li>
